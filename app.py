...
st.markdown("<div style='display: flex; justify-content: center;'><hr style='height: 2px; background-color: gray; width: 600px; border: none;'></div>", unsafe_allow_html=True)
